  ...
  return (
    <section className="live-data-state" role="status" aria-live="polite">
      ...
      <div>
        ...
        <p>{snapshot.status.processDetected ? "GlassScout detected FM26 but could not validate the active save and its football entities for this game build." : "GlassScout will connect automatically when the active game becomes available."}</p>
      </div>
