...
Version `0.1.19` supports FM26 `6000.0.52.8888375`, product `6000.0.52f1-fm26-05f1 (87a0370e9917)`, x64, executable SHA-256 `3653C97F9CCEC2BE28EDC4FAAE67304B5B6C26733F2F07DEA3E7C591D3B9FF73`.

The native FM26 reader is now split into the Layer 1 core modules: `process.rs`, `permissions.rs`, `memory.rs`, `scanner.rs`, `offsets.rs`, `structs.rs`, `parser.rs` and `validator.rs`. Data-domain and graphics modules are also present for players, clubs, nations, tactics, scout knowledge, face config parsing and logo resolution.
...
Download [GlassScout FM26 0.1.19 for Windows x64](https://github.com/TobiasTest22/GlassScout/releases/download/app-v0.1.19/GlassScout.FM26_0.1.19_x64-setup.exe).
